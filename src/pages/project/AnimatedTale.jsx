      ...
      <section className={classes.section2}>
        ...
        <div className={classes.section2__information}>
          ...
          <div className={classes.section2__container}>
            <div className={classes.container__box}>
              <h3>Supported by</h3>
              <h3 className={classes.mono__p}>Korea Art Management Service, ARTS KOREA LAB</h3>
            </div>
            <div className={classes.container__box}>
              <h3>Date</h3>
      ...
      <section className={classes.contant}>
        <div className={classes.contant__description}>
          <div className={classes.descriptionWrapper}>
            <h3>
              본 프로젝트는 애니메이션 제작 과정에서의 복잡하고 시간 소모적인 작업들을 AI를 이용해
              간소화 함으로써 일반 사용자들도 간단한 애니메이션 제작을 경험해볼 수 있도록 돕기 위해
              제작되었습니다.
            </h3>
            <h3>
              본 프로젝트를 통해 사용자는 원하는 2D 캐릭터 그림에 모션을 적용하고 자동으로 렌더링
              하여 gif 파일로 추출할 수 있습니다. 사용자는 원하는 모션을 선택하거나 직접 영상을
              촬영하여 생성할 수 있습니다. 또한, 사용자의 선호에 따라, 캐릭터의 크기, 위치, 해상도,
              모션 속도 등을 조정할 수 있습니다.
            </h3>
            <h3>
              본 프로젝트를 통해 애니메이션 제작의 접근성을 높여 누구나 쉽게 원하는 간단한
              애니메이션을 제작할 수 있을 것으로 기대합니다.
            </h3>
          </div>
          ...
          <div className={classes.sub}>
            ...
            <h3>3D bvh 모션 데이터를 2D 캐릭터의 뼈대에 적용하여 애니메이션 생성</h3>
          </div>
